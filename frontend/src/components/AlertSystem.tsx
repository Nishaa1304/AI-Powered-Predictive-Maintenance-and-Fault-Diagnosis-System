        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-3">
              ...
              <div className="text-2xl font-bold text-white">{statistics.vehiclesScheduled}</div>
            </div>
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-3">
              <div className="text-purple-400 text-xs mb-1">Calls Done</div>
              <div className="text-2xl font-bold text-white">{statistics.callsCompleted}</div>
            </div>
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3">
              <div className="text-yellow-400 text-xs mb-1">Mfg Insights</div>
              <div className="text-2xl font-bold text-white">{statistics.manufacturingInsights}</div>
            </div>
          </div>
