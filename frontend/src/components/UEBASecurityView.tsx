    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-2">User and Entity Behavior Analytics</p>
        </div>
      </div>

      {/* Main Status Card - Similar to UEBAIndicator */}
      <div className={`${config.bgColor} border ${config.borderColor} rounded-2xl p-6`}>
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">UEBA Monitoring Active</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
            <span className="text-gray-400 text-xs block mb-1">Agents Monitored</span>
            <span className="font-bold text-white text-xl">{securityStats.agentsMonitored}/6</span>
          </div>
          <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
            <span className="text-gray-400 text-xs block mb-1">Active Threats</span>
            <span className="font-bold text-red-400 text-xl">{securityStats.activeThreats}</span>
          </div>
          <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
            <span className="text-gray-400 text-xs block mb-1">Anomalies Detected</span>
            <span className="font-bold text-yellow-400 text-xl">{securityStats.anomaliesDetected}</span>
          </div>
          <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
            <span className="text-gray-400 text-xs block mb-1">Threats Blocked</span>
            <span className="font-bold text-green-400 text-xl">{securityStats.threatsBlocked}</span>
          </div>
          <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
            <span className="text-gray-400 text-xs block mb-1">Avg Risk Score</span>
            <span className="font-bold text-blue-400 text-xl">{securityStats.averageRiskScore}</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-white">Active Threats & Incidents</h2>
          ...
          <div className="space-y-3 max-h-[500px] overflow-y-auto custom-scrollbar">
            {threats.map((threat) => (
              ...
              >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="font-bold text-white text-sm">{threat.type}</span>
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div>
                          ...
                          <span className="text-gray-300 ml-1 font-mono">{threat.source}</span>
                        </div>
                        <div>
                          <span className="text-gray-500">Target:</span>
                          <span className="text-gray-300 ml-1">{threat.target}</span>
                        </div>
                      </div>
                ...
                <button className="w-full mt-2 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg text-xs font-semibold transition-colors">
        ...
        <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-white">High-Risk Behavior Patterns</h2>
          ...
          <div className="space-y-3">
            {riskPatterns.map((pattern, index) => (
              <div
                key={index}
                className="bg-gray-800/50 border border-gray-700 rounded-xl p-4 hover:border-yellow-500/50 transition-all"
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="font-bold text-white text-sm block">{pattern.entity}</span>
                      <span className="text-xs text-gray-400">{pattern.type}</span>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-xl font-bold text-yellow-400">{pattern.riskScore}</div>
                ...
                <div className="bg-gray-900/50 rounded-lg p-2 mb-3">
                  <span className="text-xs text-gray-400 block mb-1">Detected Anomalies:</span>
                  <span className="text-xs text-gray-300">{pattern.anomalies}</span>
                </div>

                <div className="flex gap-2">
                  <button className="flex-1 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg text-xs font-semibold transition-colors">
                    View Details
                  </button>
          ...
          <div className="mt-6 bg-gray-800/50 border border-gray-700 rounded-xl p-4">
            <h3 className="text-sm font-bold text-white mb-3">Anomaly Score Timeline (24h)</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <button className="bg-gray-800/50 hover:bg-gray-800 border border-gray-700 hover:border-blue-500/50 rounded-xl p-6 transition-all text-left group">
          <div className="text-3xl mb-3">🛡️</div>
          <h3 className="font-bold text-white mb-2 group-hover:text-blue-400 transition-colors">Run Security Scan</h3>
          <p className="text-sm text-gray-400">Perform full system audit across all agents</p>
        </button>
        <button className="bg-gray-800/50 hover:bg-gray-800 border border-gray-700 hover:border-purple-500/50 rounded-xl p-6 transition-all text-left group">
          <div className="text-3xl mb-3">📊</div>
          <h3 className="font-bold text-white mb-2 group-hover:text-purple-400 transition-colors">View Detailed Reports</h3>
          <p className="text-sm text-gray-400">Access comprehensive security analytics</p>
        </button>
        <button className="bg-gray-800/50 hover:bg-gray-800 border border-gray-700 hover:border-green-500/50 rounded-xl p-6 transition-all text-left group">
          <div className="text-3xl mb-3">⚙️</div>
          <h3 className="font-bold text-white mb-2 group-hover:text-green-400 transition-colors">Configure Security Rules</h3>
          <p className="text-sm text-gray-400">Manage policies and access controls</p>
        </button>
      </div>
    </div>
  );
