    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Monitor and manage all vehicles</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm font-medium">Good</p>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    {vehicle.alerts > 0 && (
                      <span className="flex items-center text-xs font-semibold px-2 py-1 bg-red-100 text-red-700 rounded-full">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm text-gray-600">
                    <div>
                      <span className="font-medium">VIN:</span> {vehicle.id}
                    </div>
                    <div>
                    ...
                    <div>
                      <span className="font-medium">Last Service:</span> {vehicle.lastService}
                    </div>
                  </div>
                </div>
                <div className="text-right ml-4">
                  ...
                  <div className="relative w-16 h-16">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-lg font-bold text-gray-900">{vehicle.healthScore}</span>
                    </div>
                  </div>
                </div>
              </div>
